...
public class ManaPedestalModel {
	
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(CMConstants.modLoc("mana_pedestal"), "main");
	...
	public ManaPedestalModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition sw = shards.addOrReplaceChild("sw", CubeListBuilder.create().texOffs(0, 15).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 0.0F, 4.0F));
		
		PartDefinition se = shards.addOrReplaceChild("se", CubeListBuilder.create().texOffs(0, 15).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 0.0F, 4.0F));
		
		PartDefinition ne = shards.addOrReplaceChild("ne", CubeListBuilder.create().texOffs(0, 15).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-4.0F, 0.0F, -4.0F));
		
		PartDefinition nw = shards.addOrReplaceChild("nw", CubeListBuilder.create().texOffs(0, 15).addBox(-1.0F, -5.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, 0.0F, -4.0F));
		...
		PartDefinition core = main.addOrReplaceChild("core", CubeListBuilder.create().texOffs(0, 7).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -8.625F, 0.0156F));
