...
public class TradingRiftRecipe extends ProcessingRecipe<Container> {
    
    private int manaRequired;
    
    public TradingRiftRecipe(ProcessingRecipeBuilder.ProcessingRecipeParams params) {
        super(CMBotaniaRecipes.TRADING_RIFT_TYPE, params);
        
        if(params instanceof TradingRiftRecipeBuilder.TradingRiftRecipeParams p) {
