...
public class TradeManaPedestalBlockEntityRenderer extends SafeBlockEntityRenderer<TradeManaPedestalBlockEntity> {
    ...
    @Override
    protected void renderSafe(TradeManaPedestalBlockEntity be, float partialTicks, PoseStack ms, MultiBufferSource buffer,
                              int light, int overlay) {
        
        VertexConsumer shardVC = buffer.getBuffer(RenderHelper.NATURA_PYLON_GLOW);
