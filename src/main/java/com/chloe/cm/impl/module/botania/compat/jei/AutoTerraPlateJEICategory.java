...
public class AutoTerraPlateJEICategory implements IRecipeCategory<AutoTerraPlateRecipe> {
    
    public AutoTerraPlateJEICategory() {
    }
    
    @Override
    public RecipeType<AutoTerraPlateRecipe> getRecipeType() {
        return CMBotaniaJEIPlugin.AUTO_TERRA_PLATE_TYPE;
    }
    ...
    public Component getTitle() {
        return Component.translatable("category." + CMConstants.MODID + ".auto_terra_plate");
    }
    
    @Override
    public @Nullable IDrawable getIcon() {
        return new ItemIcon(CMBotaniaBlocks.AUTO_TERRA_PLATE.get().asItem()::getDefaultInstance);
    }
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, AutoTerraPlateRecipe recipe, IFocusGroup iFocusGroup) {
    ...
    @Override
    public void draw(AutoTerraPlateRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics graphics, double mouseX, double mouseY) {
        int arrowWidth = AllGuiTextures.JEI_ARROW.getWidth();
